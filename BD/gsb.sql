...
INSERT INTO `compte` (`id_Co`, `Mdp_co`, `Mail_co`, `grade`, `mat_vis`) VALUES
(1, '$2y$10$Ad8dVjCvFXxulv71wkMbTel1JlWl71kX7SydyW3OOLcMTAeCBSZ9m', 'erwann.cabaret@gmail.com', 5, 'i12'),
...
(25, '$2y$10$J.mHRNc..SoHidlAvC4O.OW2bGBzPDeZWd1KxiMYWdOTnldRLRswy', 'villechalane.louis@hotmail.fr', 1, 'a131'),
(26, '$2y$10$6aJQ5MSW8gzUR6cuD/zHNuZHtu/BO4pmq.dJlY33XsTyil/a1RNTu', 'bedos.christian@hotmail.fr', 2, 'a55');
...
INSERT INTO `presente` (`id`, `VIS_MATRICULE`, `RAP_NUM`, `produit1`, `produit2`) VALUES
...
INSERT INTO `rapport_visite` (`VIS_MATRICULE`, `RAP_NUM`, `PRA_NUM`, `remplacant`, `RAP_DATE`, `RAP_BILAN`, `RAP_MOTIF`, `saisieDef`) VALUES
('', 156, 15, 'Aucun', '2024-03-21 14:55:00', 'Oui', 'Actualisation', 'oui'),
('a131', 3, 23, 'Aucun', '2002-04-18 00:00:00', 'Médecin curieux, à recontacer en décembre pour réunion', 'Actualisation annuelle', 'oui'),
('a131', 5, 23, 'Aucun', '2002-04-18 00:00:00', 'Médecin curieux, à recontacer en décembre pour réunion', 'Actualisation annuelle', 'oui'),
('a131', 7, 41, 'Aucun', '2003-03-23 00:00:00', 'RAS\r\nChangement de tel : 05 89 89 89 89', 'Rapport Annuel', 'oui'),
('a131', 8, 41, 'Aucun', '2003-03-23 00:00:00', 'RAS\r\nChangement de tel : 05 89 89 89 89', 'Rapport Annuel', 'oui'),
('a131', 18, 23, 'Aucun', '2002-04-18 00:00:00', 'Médecin curieux, à recontacer en décembre pour réunion', 'Actualisation annuelle', 'non'),
...
('a131', 'Villechalane', 'Louis', '8 cours Lafontaine', '29000', 'BREST', '1992-12-11 00:00:00', 'P', 'SW'),
('a17', 'Faranda', 'Héloïse', '1 r Aimon de Chissée', '38100', 'GRENOBLE', '1991-08-26 00:00:00', 'E', 'GY'),
...
('b4', 'Charoze', 'Catherine', '100 pl Géants', '33000', 'BORDEAUX', '1997-09-25 00:00:00', 'P', 'SW'),
...
('i12', 'cabaret', 'erwann', '8 chemin des vignerons', '45130', 'Meung sur loire', '2019-08-21 15:22:14', 'N', 'er'),
('i13', 'benjaballah', 'zakarya', '12 rue des anes', '45000', 'orleans', '2020-11-03 15:17:49', 'S', 'er'),
('ii23', 'benjaballi', 'zakette', '12 rue des anes', '45000', 'orleans', '2020-11-03 15:17:49', 'E', 'er'),
...
--
ALTER TABLE `rapport_visite`
  MODIFY `RAP_NUM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
...
--
ALTER TABLE `compte`
  ADD CONSTRAINT `fk_compte` FOREIGN KEY (`mat_vis`) REFERENCES `visiteur` (`VIS_MATRICULE`);
...
--
ALTER TABLE `inclure`
  ADD CONSTRAINT `inclure_fiche_frais0_FK` FOREIGN KEY (`vis_matricule`,`ff_mois`) REFERENCES `fiche_frais` (`vis_matricule`, `ff_mois`),
...
--
ALTER TABLE `realiser`
  ADD CONSTRAINT `realiser_activite_compl0_FK` FOREIGN KEY (`AC_NUM`) REFERENCES `activite_compl` (`AC_NUM`),
  ADD CONSTRAINT `realiser_visiteur1_FK` FOREIGN KEY (`VIS_MATRICULE`) REFERENCES `visiteur` (`VIS_MATRICULE`);
...
--
ALTER TABLE `travailler`
  ADD CONSTRAINT `travailler_region1_FK` FOREIGN KEY (`REG_CODE`) REFERENCES `region` (`REG_CODE`),
...
--
ALTER TABLE `visiteur`
  ADD CONSTRAINT `visiteur_secteur0_FK` FOREIGN KEY (`SEC_CODE`) REFERENCES `secteur` (`SEC_CODE`);
COMMIT;
