...
<?php $infoRapportVisite=getLesDetailsDesPraticiensRapport($misMat[0]['mat_vis'],$dateDebut,$dateFin); ?>
...
<?php $numRap=0; ?>
<?php if(sizeof($infoRapportVisite) > 0):?>
<?php foreach ($infoRapportVisite as $uneInfoRapportVisite) { ?>
<?php $numEche=0; ?>
  <?php $praNom=getPraNom($uneInfoRapportVisite['PRA_NUM']); ?>
  <?php $praNomRemplacant=getPraNom($uneInfoRapportVisite['remplacant']); ?>
  ...
  <div class="card text-center mt-4 mb-4">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Echantillion Offert:    
       ...
       <?php 
       if ($uneInfoRapportVisite['saisieDef'] == 'non') { ?>
        <form method="post" action="index.php?uc=rapport&action=modifierRapport&visMat=<?= $uneInfoRapportVisite['VIS_MATRICULE']; ?>&idRap=<?= $uneInfoRapportVisite['RAP_NUM']; ?>" class=" d-flex justify-content-center">
