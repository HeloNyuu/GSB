...
<section>
	...
	<FORM action="index.php?uc=gestionPage&action=voirInfoPrat" method="post">
    ...
    foreach ($lesPraticiens as $unPraticien) {
    	echo '<OPTION value='.$unPraticien['PRA_NOM'].'>'.$unPraticien['PRA_NOM'].'-'.$unPraticien['PRA_PRENOM'].'</OPTION>';
    }
